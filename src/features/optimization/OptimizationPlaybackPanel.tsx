...
export function OptimizationPlaybackPanel(props: OptimizationPlaybackPanelProps) {
  ...
  return (
    <div
      ...
      data-testid="optimization-playback-panel"
      role="dialog"
      aria-label="Simulación de recorrido"
    >
      <div class="flex items-start justify-between gap-3 border-b border-default px-4 py-3">
        <div>
          <h3 class="font-heading text-base font-semibold text-text-primary">Simular recorrido</h3>
        ...
        <Show when={!props.loading && !props.error}>
          <Card>
            ...
            <p class="mt-3 text-xs text-text-muted">
              Escenario del plan: <span class="font-mono">{props.scenarioId}</span>
            </p>
          </Card>
