...
const MOCK_ROUTES: DailyRoutePlaybackResponse['routes'] = [
  {
    ...
    stops: [
      ...
      { sequence: 2, lng: -62.721, lat: 8.297, code: 'CNT-002', serviceMinutes: 5 },
      { sequence: 3, lng: -62.724, lat: 8.298, code: 'CNT-003', serviceMinutes: 5 },
    ],
  ...
  },
  {
    ...
    stops: [
      { sequence: 1, lng: -62.717, lat: 8.297, code: 'CNT-010', serviceMinutes: 5 },
      { sequence: 2, lng: -62.712, lat: 8.293, code: 'CNT-011', serviceMinutes: 5 },
    ],
  ...
  },
  {
    ...
    stops: [
      { sequence: 1, lng: -62.719, lat: 8.291, code: 'CNT-020', serviceMinutes: 5 },
      { sequence: 2, lng: -62.716, lat: 8.286, code: 'CNT-021', serviceMinutes: 5 },
    ],
