# Fase 0 — Alineación y criterios de éxito

Documentación de referencia para el rediseño del flujo guiado de **Simulación** (Opción A: Optimización como módulo operativo secundario).
...
| [adr-contingencias.md](./adr-contingencias.md) | ADR-003: recuperación ante contingencias (re-optimización ACO localizada) |
| [../post-grado/README.md](../post-grado/README.md) | **Backlog post-grado** (OR-Tools, SSE, tráfico live, etc.) |

**Estado:** completado (Fase 0)  
**Fecha:** 2026-08-08  
**Decisión clave:** Simulación = ruta principal; Optimización = operativa secundaria
